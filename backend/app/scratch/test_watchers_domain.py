...
from app.watchers.builder import compile_trigger_dsl
...
def test_builder_offline():
    with patch("app.watchers.builder.genai.Client") as mock_client:
...
def test_engine_run():
    ...
    from app.repositories.watcher_repository import save_watcher, delete_watcher
