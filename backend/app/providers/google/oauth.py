...
from app.providers.google.google_oauth import get_authorization_url, exchange_code
from app.repositories.db_client import store_tokens, is_connected, load_tokens
...
async def google_disconnect() -> dict:
    ...
    from app.repositories.db_client import _read_cache, _write_cache, _get_supabase  # noqa: PLC0415
